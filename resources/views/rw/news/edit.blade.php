<x-rw-app-layout>
    ...
    <div class="max-w-4xl mx-auto pb-12">
        <form action="{{ route('rw.berita.update', $news->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
            @csrf
            @method('PUT')
