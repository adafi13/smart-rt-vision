<x-rw-app-layout title="Tiket {{ $ticket->ticket_number }}" header="Detail Tiket">
@php
        ...
        <div class="lg:col-span-8">
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col" style="min-height:580px">
                ...
                <div class="border-t border-slate-100 dark:border-slate-700 p-5">
                    <form method="POST" action="{{ route('rw.tickets.reply', $ticket) }}" enctype="multipart/form-data">
                        @csrf
                    ...
                    <form id="closeTicketForm" method="POST" action="{{ route('rw.tickets.close', $ticket) }}" class="hidden">@csrf</form>
                </div>
                @else
