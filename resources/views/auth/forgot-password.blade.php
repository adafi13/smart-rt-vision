<x-guest-layout>
    ...
    <div class="fade-in-up">
        ...
        <p style="font-size:14px;color:#64748b;font-weight:500;line-height:1.6;margin:0 0 32px;">
            Jangan panik! Masukkan alamat email yang terdaftar dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi Anda.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}" id="forgotForm" class="fade-in-up" style="display:flex;flex-direction:column;gap:20px;animation-delay:0.1s;">
        @csrf
        <div>
        ...
        <button type="submit" id="forgotBtn" class="auth-btn" style="margin-top:4px;">
        ...
        <div style="display:flex;flex-direction:column;gap:28px;">
            <div class="fade-in-up">
                <h2 style="font-size:32px;font-weight:900;color:#fff;letter-spacing:-0.03em;line-height:1.15;margin:0 0 12px;">
                    Keamanan <span style="color:#60a5fa;">Nomor Satu.</span>
                </h2>
                <p style="font-size:13px;color:rgba(255,255,255,0.5);font-weight:500;line-height:1.7;margin:0;">
                    Sistem SmartRT Vision dilengkapi dengan keamanan enkripsi AES-256 tingkat perbankan untuk melindungi data Anda.
                </p>
            </div>
            ...
            <div class="glass-card fade-in-up" style="padding:14px 18px;border-radius:14px;display:flex;align-items:center;gap:14px;">
                <div class="glass-icon" style="width:40px;height:40px;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    <svg style="width:20px;height:20px;color:#60a5fa;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                </div>
                <div>
                    <h4 style="font-size:11px;font-weight:800;color:#fff;text-transform:uppercase;letter-spacing:0.08em;margin:0 0 2px;">Pemulihan Cepat</h4>
                    <p style="font-size:10px;color:rgba(255,255,255,0.4);font-weight:500;margin:0;">Proses reset sandi otomatis dan terenkripsi</p>
                </div>
            </div>
        </div>
    </x-slot>
