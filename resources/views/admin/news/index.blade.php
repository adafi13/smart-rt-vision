<x-app-layout title="Kelola Berita & Pengumuman">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a href="{{ route('admin.berita.create') }}" class="w-full sm:w-auto px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl transition-colors shadow-sm flex items-center justify-center gap-2">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors group align-top">
                        ...
                        <td class="px-6 py-4 text-right whitespace-nowrap">
                            <div class="flex justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                <a href="{{ route('admin.berita.edit', $n->id) }}" class="p-2 rounded-lg text-indigo-600 hover:bg-indigo-50 transition-colors inline-block" title="Edit">
        ...
        <div class="md:hidden space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative">
                ...
                <div class="p-3 bg-gray-50/50 border-t border-gray-50 flex gap-2 {{ $n->is_penting ? 'pl-5' : '' }}">
                    <a href="{{ route('admin.berita.edit', $n->id) }}" class="flex-1 py-1.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 text-[11px] font-bold rounded-lg transition-colors shadow-sm flex items-center justify-center gap-1.5">
