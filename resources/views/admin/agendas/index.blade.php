                                ...
                                @forelse($agendas as $agenda)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="p-4 text-right flex items-center justify-end gap-2">
                                            <a href="{{ route('admin.agendas.edit', $agenda->id) }}" class="text-indigo-600 hover:text-indigo-900 font-semibold text-xs bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-colors inline-block whitespace-nowrap">Edit</a>
                        ...
                        @foreach($agendas as $agenda)
                            <div class="bg-white border border-gray-100 p-4 rounded-2xl shadow-sm flex flex-col gap-3">
                                ...
                                <div class="flex items-center gap-2 mt-2 pt-3 border-t border-gray-100">
                                    <a href="{{ route('admin.agendas.edit', $agenda->id) }}" class="flex-1 text-center font-bold text-xs bg-indigo-50 text-indigo-700 hover:bg-indigo-100 py-2.5 rounded-xl transition-colors">Edit</a>
