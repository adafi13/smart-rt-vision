<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-900 leading-tight">Tambah Pengurus RT Baru</h2>
                <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah ini untuk memberikan akses ke pengurus baru.</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6 sm:p-8 border-b border-gray-100">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Data diri pengurus yang akan didaftarkan.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="input-field bg-gray-50 focus:bg-white" required placeholder="Contoh: Budi Santoso">
                            @error('name') <span class="text-xs text-rose-500 mt-1">{{ $message }}</span> @enderror
                        </div>
                        
                        <div>
                            <label class="label">Email / Username</label>
                            <input type="email" name="email" value="{{ old('email') }}" class="input-field bg-gray-50 focus:bg-white" required placeholder="Contoh: budi@rt01.com">
                        ...
                        <div>
                            ...
                            <input type="text" name="password" class="input-field bg-gray-50 focus:bg-white" required placeholder="Minimal 8 karakter">
                            <p class="text-[11px] text-gray-500 mt-1.5">Password bawaan yang nanti bisa diubah oleh pengurus sendiri.</p>
                ...
                <div class="p-6 sm:p-8 bg-gray-50/50">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Tentukan menu apa saja yang bisa diakses oleh pengurus ini.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                            <div class="flex items-center h-5">
                                <input name="tenant_role" type="radio" value="sekretaris" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                            </div>
                            <div class="ms-4">
                        ...
                        <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                            <div class="flex items-center h-5">
                                <input name="tenant_role" type="radio" value="bendahara" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                            </div>
                            <div class="ms-4">
                        ...
                        <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                            <div class="flex items-center h-5">
                                <input name="tenant_role" type="radio" value="wakil_ketua" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                            </div>
                            <div class="ms-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                                <div class="flex items-center h-5">
                                    <input name="tenant_role" type="radio" value="keamanan" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                                </div>
                                <div class="ms-4">
                            ...
                            <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                                <div class="flex items-center h-5">
                                    <input name="tenant_role" type="radio" value="humas" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                                </div>
                                <div class="ms-4">
                            ...
                            <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                                <div class="flex items-center h-5">
                                    <input name="tenant_role" type="radio" value="pembangunan" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                                </div>
                                <div class="ms-4">
                            ...
                            <label class="relative flex p-4 cursor-pointer bg-white border border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50/30 transition-all has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50 has-[:checked]:ring-1 has-[:checked]:ring-indigo-600">
                                <div class="flex items-center h-5">
                                    <input name="tenant_role" type="radio" value="owner" class="w-5 h-5 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-600" required>
                                </div>
                                <div class="ms-4">
