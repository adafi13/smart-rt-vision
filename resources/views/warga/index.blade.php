            ...
            <form method="GET" action="{{ route('warga.index') }}" class="flex flex-col gap-4">
                ...
                <div class="border-t border-gray-100 pt-4 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                        ...
                        <button type="button" onclick="triggerPdfPreview('{{ route('export.pdf', ['preview' => 1]) }}', '{{ route('export.pdf') }}')" class="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-rose-50 text-rose-700 border border-rose-200 hover:bg-rose-100 rounded-lg text-xs font-semibold transition-colors">
