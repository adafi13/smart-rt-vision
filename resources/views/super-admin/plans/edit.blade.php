<x-super-admin-layout title="Edit Paket" header="Manajemen Paket Berlangganan">
    <div class="max-w-5xl mx-auto pb-20">
        ...
        <div class="relative mb-10 text-center">
            ...
            <h1 class="text-4xl font-black text-slate-800 dark:text-white tracking-tight mb-2">
                Ubah Konfigurasi <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-400">Paket</span>
            </h1>
            <p class="text-slate-400 dark:text-slate-500 font-medium">Perbarui detail, harga, atau batasan fitur paket "{{ $plan->name }}".</p>
        </div>

        <form action="{{ route('super-admin.plans.update', $plan) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-8 space-y-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 mb-6">
                            <div class="group">
                                ...
                                <textarea name="description" rows="3" 
                                          ...
                                          class="w-full bg-slate-50 dark:bg-slate-800/50 border-0 rounded-2xl px-6 py-4 text-slate-800 dark:text-white font-medium focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300">{{ old('description', $plan->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="group">
                                <div class="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-4 transition-all group-focus-within:ring-2 group-focus-within:ring-indigo-500">
                                    ...
                                    <input type="number" name="{{ $key }}" value="{{ old($key, $plan->$key) }}" min="1" placeholder="{{ $def }}"
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            @php
                                $isActive = old('features.' . $key) !== null ? old('features.' . $key) : ($planFeatures[$key] ?? false);
                            @endphp
                    ...
                    <div class="bg-slate-900 rounded-[3rem] shadow-2xl relative overflow-hidden text-white border border-slate-800 flex flex-col">
                        ...
                        <div class="p-8 pb-6 relative z-10">
                            ...
                            <div class="space-y-5" x-data="{ 
                                monthly: '{{ old('price_monthly', $plan->price_monthly) }}',
                                yearly: '{{ old('price_yearly', $plan->price_yearly) }}',
                        ...
                        <div class="p-8 pt-6 relative z-10 flex flex-col gap-6">
                            ...
                            <label class="flex items-center justify-between p-4 bg-white/[0.02] border border-white/5 rounded-2xl cursor-pointer group hover:bg-white/[0.05] transition-all">
                                ...
                                <div class="relative inline-flex items-center">
                                    ...
                                    <input type="checkbox" name="is_popular" value="1" {{ old('is_popular', $plan->is_popular) ? 'checked' : '' }} class="sr-only peer">
