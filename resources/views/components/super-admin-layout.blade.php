...
<head>
    ...
    <meta name="robots" content="noindex, nofollow"> <!-- Prevent indexing of super admin dashboard -->
    <meta name="description" content="Super Admin Dashboard for SmartRT Vision Enterprise.">
    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 p-3 overflow-y-auto">
                ...
                <a href="{{ route('super-admin.rws.index') }}" class="sa-nav-item {{ request()->routeIs('super-admin.rws.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('super-admin.articles.index') }}" class="sa-nav-item {{ request()->routeIs('super-admin.articles.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
                    Manajemen Blog
                </a>
                @endif
                ...
                <a href="{{ route('super-admin.settings.index') }}" class="sa-nav-item {{ request()->routeIs('super-admin.settings.*') ? 'active' : '' }}">
