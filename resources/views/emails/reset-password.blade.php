...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <p>Anda menerima email ini karena kami menerima permintaan reset kata sandi untuk akun Anda di sistem SmartRT Vision.</p>
            ...
            <div class="footer">
                <p class="muted">Jika Anda kesulitan mengklik tombol "Reset Kata Sandi", salin dan tempel URL berikut ke peramban web Anda:</p>
